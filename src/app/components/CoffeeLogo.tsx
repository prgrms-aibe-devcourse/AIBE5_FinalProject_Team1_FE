    ...
    >
      <defs>
        ...
        <linearGradient id="faceGlow" x1="119" y1="132" x2="233" y2="263" gradientUnits="userSpaceOnUse">
          ...
          <stop offset="1" stopColor="var(--soft-mint)" />
        </linearGradient>

        <linearGradient id="mugCyber" x1="52" y1="218" x2="154" y2="292" gradientUnits="userSpaceOnUse">
          <stop stopColor="#07101D" />
          <stop offset="1" stopColor="var(--deep-teal)" />
        </linearGradient>

        <filter id="cyanGlow" x="-30%" y="-30%" width="170%" height="170%">
          <feDropShadow dx="0" dy="0" stdDeviation="4" floodColor="var(--neon-cyan)" floodOpacity="0.70" />
          <feDropShadow dx="0" dy="0" stdDeviation="14" floodColor="var(--neon-cyan)" floodOpacity="0.22" />
        </filter>

        <filter id="greenGlow" x="-30%" y="-30%" width="170%" height="170%">
          <feDropShadow dx="0" dy="0" stdDeviation="4" floodColor="var(--matrix-green)" floodOpacity="0.85" />
          <feDropShadow dx="0" dy="0" stdDeviation="14" floodColor="var(--matrix-green)" floodOpacity="0.25" />
        </filter>
      ...
      >
        ...
        >
          ...
          >
            <path d="M105 123 125 62l42 52" fill="#EAF7FF" stroke="var(--neon-cyan)" strokeWidth="8" strokeLinejoin="round" />
            <motion.path
          ...
          >
            <path d="M246 123 226 62l-42 52" fill="#EAF7FF" stroke="var(--neon-cyan)" strokeWidth="8" strokeLinejoin="round" />
            <motion.path
          ...
          <motion.circle
            ...
            cy="216"
            r="4"
            fill={isRiskMood ? "#FFB4B4" : "var(--neon-cyan)"}
            opacity="0.35"
        ...
        >
          <path d="M132 232h90c8 0 14 6 13 14l-6 34H125l-6-34c-1-8 5-14 13-14Z" fill="#050B14" stroke="var(--neon-cyan)" strokeWidth="4" />
          <motion.path
          ...
          <motion.ellipse
            ...
            style={{ transformBox: "fill-box", transformOrigin: "50% 50%" }}
          />
          <path d="M107 280h140l-12 18H119l-12-18Z" fill="#050B14" stroke="var(--neon-cyan)" strokeWidth="3" />
        </motion.g>
        ...
        >
          ...
          />
          <ellipse cx="91" cy="221" rx="38" ry="13" fill="#050B14" stroke="var(--neon-cyan)" strokeWidth="7" />
          <path d="M127 237h12c13 0 20 10 16 22-4 12-14 19-30 19" fill="none" stroke="var(--neon-cyan)" strokeWidth="10" strokeLinecap="round" />
          <text x="65" y="242" fill="var(--matrix-green)" fontSize="10.5" fontFamily="ui-monospace, SFMono-Regular, Menlo, monospace">
            PR
          </text>
          <text x="88" y="259" fill="var(--neon-cyan)" fontSize="10.5" fontFamily="ui-monospace, SFMono-Regular, Menlo, monospace">
            API
          </text>
          <text x="68" y="276" fill="var(--matrix-green)" fontSize="10.5" fontFamily="ui-monospace, SFMono-Regular, Menlo, monospace">
            ERD
          </text>
        </motion.g>
