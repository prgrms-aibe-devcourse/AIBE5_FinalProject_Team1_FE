...
export function WorkspaceProvider({children}: { children: ReactNode }) {
    ...
    useEffect(() => {
        ...
        const subs = [
            client.subscribe<{ type?: string; action?: string; workspaceId?: number }>(
                ...
                (event) => {
                    ...
                    if (event.type === "MEMBER_EVENT" && event.action === "REMOVED" && event.workspaceId === workspaceId) {
